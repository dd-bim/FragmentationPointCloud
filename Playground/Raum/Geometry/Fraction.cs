...
public readonly record struct Fraction(Int128 Num, Int128 Den) : IComparable<Fraction>, IEquatable<Fraction>
{
    ...
    public double Value
    {
        get
        {
            ...
            // Für kleine Werte direkte Division
            if (Num < (Int128)MaxDoubleInt && Den < (Int128)MaxDoubleInt)
                return (double)Num / (double)Den;

            // Für große Werte: Dezimalbruch berechnen und parsen
            // S(17) liefert maximal Double-Präzision
            return double.Parse(S(17), System.Globalization.CultureInfo.InvariantCulture);
        }
    }
