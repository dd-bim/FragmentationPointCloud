...
namespace Revit.GUI
{
    ...
    public class GuiGreen3DScan : IExternalApplication
    {
        public Result OnStartup(UIControlledApplication application)
        {
            ...
            var loadStations =
                panel3.AddItem(new PushButtonData("11", "LoadStations", thisAssemblyPath,
            ...
            var AddStation =
                panel3.AddItem(new PushButtonData("12", "AddStation", thisAssemblyPath, "Revit.Green3DScan.SimulatePointCloud.AddStation"))
                    as PushButton;
            ...
            var saveStations =
                panel3.AddItem(new PushButtonData("13", "SaveStations", thisAssemblyPath,
                    "Revit.Green3DScan.SimulatePointCloud.SaveStations")) as PushButton;
            saveStations?.ToolTip = "Saves stations to a CSV file.";
            saveStations?.LargeImage = GetBitmapFromResx(ResourcePng.saveStations);

            panel3.AddSeparator();

            var route3 = panel3.AddItem(new PushButtonData("14", "BIM2FaceObjects", thisAssemblyPath,
            ...
            var stations =
                panel3.AddItem(new PushButtonData("15", "BIM2Stations", thisAssemblyPath,
            ...
            var raster =
                panel3.AddItem(new PushButtonData("16", "Grid", thisAssemblyPath, "Revit.Green3DScan.SimulatePointCloud.Raster")) as
                    PushButton;
            raster?.ToolTip = "Creates a grid of stations according to the settings.";
            raster?.LargeImage = GetBitmapFromResx(ResourcePng.grid);

            var Stations2NotVisibleFaces = panel3.AddItem(new PushButtonData("17", "Stations2NotVisibleFaces",
            ...
            var stationsPointClouds = panel3.AddItem(new PushButtonData("18", "Stations2PointClouds", thisAssemblyPath,
            ...
            //var server =
            //    panel4.AddItem(new PushButtonData("19", "Server", thisAssemblyPath, "Revit.Green3DScan.Server")) as
            //        PushButton;
            ...
            //var pcd2E57 =
            //    panel5.AddItem(new PushButtonData("20", "Pcd2E57", thisAssemblyPath, "Revit.Green3DScan.Pcd2E57")) as
            //        PushButton;
            //pcd2E57.ToolTip = "Converts PCD to E57.";
            //pcd2E57.LargeImage = GetBitmapFromResx(ResourcePng.tool);

            //var e572pcd =
            //    panel5.AddItem(new PushButtonData("21", "E572pcd", thisAssemblyPath, "Revit.Green3DScan.E572Pcd")) as
            //        PushButton;
