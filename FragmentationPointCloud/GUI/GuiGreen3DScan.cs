...
namespace Revit.GUI
{
    ...
    public class GuiGreen3DScan : IExternalApplication
    {
        public Result OnStartup(UIControlledApplication application)
        {
            ...
            PushButton settings = panel1.AddItem(
            ...
            var AddStation =
                panel3.AddItem(new PushButtonData("13", "AddStation", thisAssemblyPath, "Revit.Green3DScan.AddStation"))
                    as PushButton;
            ...
            var raster =
                panel3.AddItem(new PushButtonData("14", "Grid", thisAssemblyPath, "Revit.Green3DScan.Raster")) as
                    PushButton;
            ...
            var loadStations =
                panel3.AddItem(new PushButtonData("15", "LoadStations", thisAssemblyPath,
                    "Revit.Green3DScan.LoadStations")) as PushButton;
            ...
            var Stations2NotVisibleFaces = panel3.AddItem(new PushButtonData("16", "Stations2NotVisibleFaces",
                thisAssemblyPath, "Revit.Green3DScan.Stations2NotVisibleFaces")) as PushButton;
            ...
            var stationsPointClouds = panel3.AddItem(new PushButtonData("17", "Stations2PointClouds", thisAssemblyPath,
                "Revit.Green3DScan.Stations2PointClouds")) as PushButton;
